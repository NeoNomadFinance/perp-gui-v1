...
const TVChartContainer = () => {
  ...
  const defaultProps: ChartContainerProps = {
    ...
    autosize: true,
    studiesOverrides: {
      'volume.volume.color.0': theme === 'Mango' ? '#E54033' : '#ef5350',
      'volume.volume.color.1': theme === 'Mango' ? '#AFD803' : '#26a69a',
      'volume.precision': 4,
    },
  }
    ...
    const widgetOptions: ChartingLibraryWidgetOptions = {
      ...
      overrides: {
        ...
        'mainSeriesProperties.candleStyle.upColor':
          theme === 'Mango' ? '#AFD803' : '#26a69a',
        'mainSeriesProperties.candleStyle.downColor':
          theme === 'Mango' ? '#E54033' : '#ef5350',
  ...
  function getLine(order, market) {
    ...
    return tvWidgetRef.current
      ...
      .setBodyTextColor(
        theme === 'Dark' ? '#6D57AD' : theme === 'Light' ? '#FF9C24' : '#6D57AD'
      )

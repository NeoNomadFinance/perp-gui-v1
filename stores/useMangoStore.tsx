  ...
  return {
    ...
    actions: {
      ...
      async fetchAllMangoAccounts() {
        ...
        return mangoClient
          ...
          .catch((err) => {
            ...
            notify({
              type: 'error',
              title: 'Unable to load nomad account',
      ...
      async fetchMangoGroup() {
        ...
        return mangoClient
          ...
          .catch((err) => {
            ...
            notify({
              title: 'Failed to load nomad group. Please refresh',
              description: `${err}`,
              type: 'error',
            })
            console.log('Could not get nomad group: ', err)
          })
      },
      ...
      async reloadMangoAccount() {
        ...
        console.log('reloaded nomad account', reloadedMangoAccount)
      },
      async reloadOrders() {
        const mangoAccount = get().selectedMangoAccount.current
        const connection = get().connection.current
